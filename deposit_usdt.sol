...
contract mortgage is Ownable{
	...
	function deposit() public {
		...
		//取款（对方余额不足时usdt合约将会触发revert）USDT contract https://etherscan.io/address/0xdac17f958d2ee523a2206206994597c13d831ec7#code
		...
		//修改状态并记录事件
        userMap[msg.sender] = userMap[msg.sender].add(1);

        totalUserNum = totalUserNum.add(1);
	...
	function cancel() public {
		...
		//更新状态并记录事件
        userMap[msg.sender] = userMap[msg.sender].sub(1);
		
        totalUserNum = totalUserNum.sub(1);
